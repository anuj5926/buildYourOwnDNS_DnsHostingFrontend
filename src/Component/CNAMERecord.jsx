...
export default function CNAMERecord() {
  ...
  const [CnameRecordData, setCnameRecordData] = useState([]);
  ...
  useEffect(() => {
    if (Object.keys(useContextApi?.records).length > 0) {
      const data = useContextApi?.records?.Record.filter(ele => ele?.Type === "CNAME");
      setCnameRecordData(data)
    }
    ...
    <div className="container">
      <div className="page-inner mt-3">
        <div className="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
          <div>
            <h3 className="fw-bold mb-3">CNAME Record</h3>
          </div>
